...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Marketing collections shown on /collection/[slug] and the homepage featured grid';
...
export interface ApiColorColor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Color library and single color pages';
    displayName: 'Color';
    pluralName: 'colors';
    singularName: 'color';
  };
  ...
  attributes: {
    ...
    hue: Schema.Attribute.Enumeration<
      [
        'blue',
        'red',
        'green',
    ...
    >;
    image: Schema.Attribute.Media<'images'>;
    inspiration: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Localized page content fetched by slug';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Carpet products shown on /products and /products/[id]';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    collection: Schema.Attribute.Enumeration<['public', 'vip']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    limited: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
export interface ApiStatementStatement extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Artisan quotes and video statements shown on /statements and /statements/[id]';
